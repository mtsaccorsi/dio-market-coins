...
class MarketChartDataWorker {
    ...
    private var completion: ((Result<MarketChartModel?, MarketCoinsError>) -> Void)?
    ...
    func doFetchMarketChart(id: String, baseCoin: String, from: String, to: String, completion: @escaping ((Result<MarketChartModel?, MarketCoinsError>) -> Void)) {
