...
//  MarketCoins
//
//  Created by Matheus Accorsi on 30/08/23.
...
class CoinWorker {
    ...
    private var completion: ((Result<CurrentDataModel?, MarketCoinsError>) -> Void)?
    ...
    func doFetchCurrentData(id: String, completion: @escaping ((Result<CurrentDataModel?, MarketCoinsError>) -> Void)) {
